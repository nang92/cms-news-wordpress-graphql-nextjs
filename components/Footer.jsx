...
export const getRecentPosts = async () => {
  const query = gql`
    query getRecentPosts {
      posts(where: { orderby: { order: ASC, field: DATE } }, last: 3) {
        edges {
          node {
            title
            featuredImage {
...
export const getFeaturedPosts = async () => {
  const query = gql`
    query getFeaturedPosts {
      posts(where: { orderby: { order: DESC, field: DATE } }, last: 3) {
        edges {
          node {
            title
            featuredImage {
  ...
  return (
    <footer className="bg-white dark:bg-gray-800 pt-4 pb-8 xl:pt-8">
      <div className="max-w-screen-lg xl:max-w-screen-xl mx-auto px-4 sm:px-6 md:px-8 text-gray-400 dark:text-gray-300">
        <ul className="text-lg font-light pb-8 flex flex-wrap justify-between ">
          <li className="w-1/2 md:w-1/3 lg:w-1/3 px-2">
        ...
        <div className="text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            © 2022 All rights reserved. - Demo version 1.0 - Only for testing
            purposes!
          </p>
        </div>
      </div>
